    ...
    $con = new mysqli('localhost', 'root', '', 'mybank');
		...
		if (isset($_POST['cashierLogin']))
		{
		    ...
		    //   $_SESSION['user'] = $data;
			  ...
			  }else{$error = "<div class='alert alert-warning text-center rounded-0'>Username or password wrong try again!</div>";}
			
		     }
		    else
		    {
		      $error = "<div class='alert alert-warning text-center rounded-0'>Something went wrong!</div>";
		    }
		}
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                    <form method="POST">
                        <input type="email" value="miko@miko.com" name="email" class="form-control" required placeholder="Enter Email">
                        <input type="password" name="password" value="miko" class="form-control" required placeholder="Enter Password">
