...
if (isset($_POST['saveAccount']))
{
  ...
  if (!$con->query("insert into useraccounts (name,nic,accountNo,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[nic]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$password','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table table-borderless">
      <tbody>
        <tr>
          ...
          <th>NIC</th>
          <td><input type="number" name="nic" class="form-control input-sm" required></td>
        </tr>
        <tr>
